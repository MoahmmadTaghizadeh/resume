    ...
    <div className="mainWrapper">
      ...
      <div className="main">
        ...
        <p className="description">
          این پنل برای کاربران شرکت  فارزویگ ایجاد شده است تا در محیط وب خودروهای  موجود
          در انبار را ثبت کنند و مرحله به مرحله فرایند ثبت خودرو، شناسایی وضعیت خودرو، بررسی چک پوینت های موجود برای خودرو و تعیین وضعیت برای آن ها 
          (از جمله: سالم، نیازمند بررسی، نیازمند قطعه و ...)، 
          گرفتن گزارش از بخش های مختلف کار و ...  را انجام دهند.
        </p>
        <p className="description">
          در این پروژه
           من به عنوان فریلنسر توسعه و دیباگینگ  کار را بر عهده داشتم و بخش  Mega Button 
           را نیز به این 
             پنل افزودم که با فشردن آن تمامی چک پوینت های اساسی سبز می شوند و 
             صفحه جدیدی برای کاربر ایجاد می شود تا یک سری چک پوینت غیراساسی نیز کنترل شود
