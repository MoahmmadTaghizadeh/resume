    ...
    <div className="mainWrapper">
      ...
      <div className="main">
        ...
        <p className="description">
          این پنل برای ادمین های شرکت  فارزویگ ایجاد شده است تا در محیط وب  
          نواحی، مناطق، چک پوینت ها و... مورد استفاده در پنل کاربری را تعریف، ویرایش و یا حذف کنند.
          و گزارش های کاملی از کار کارکنان شرکت دریافت کنند
        </p>
        <p className="description">
          در این پروژه
           من به عنوان فریلنسر توسعه و دیباگینگ  کار را بر عهده داشتم و 
           ناحیه های غیراساسی را نیز به این پنل اضافه کردم.
           از جمله ایرادات می توان به رفع validation در فرم های ثبت منطقه و ناحیه، ثبت ترکینگ برای مگا باتن اضافه شده در پنل کاربری،
           بهبود متن خطاها و ترکینگ ها و ایجاد سطخ دسترسی برای انواع کارمندان(تعمیرکار، بازرس، پشتیبانی و ...) اشاره کرد

        </p>
        <p className="description">
          تمامی این بخش ها به صورت فول استک یعنی هم بخش
           React و هم بخش
          Node و MySQL توسط من انجام شده است
        </p>
        <br />
        <hr />
      </div>
